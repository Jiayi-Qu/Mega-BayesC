...
########################## S1
allFactor_QTLEffect_RMSE = function(nFactors, nTraits, n_replicates, nSNPs, folder = folder){
...
allFactor_QTLEffect_RMSE(nFactors, nTraits, n_repeat, nSNPs, folder = folder)
