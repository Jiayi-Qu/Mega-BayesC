...
ST_allFactor_wo_h2_markerEffect_RMSE = function(nFactors, nTraits, n_replicates, nSNPs, folder){
...
ST_allFactor_wo_h2_markerEffect_RMSE(nFactors, nTraits, n_repeat, nSNPs, folder)
