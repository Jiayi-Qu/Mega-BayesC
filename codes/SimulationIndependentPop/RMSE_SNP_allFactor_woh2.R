...
allFactor_wo_h2_SNPEffect_RMSE = function(nFactors, nTraits, n_replicates, nSNPs, folder = folder){
...
allFactor_wo_h2_SNPEffect_RMSE(nFactors, nTraits, n_repeat, nSNPs, folder = folder)
